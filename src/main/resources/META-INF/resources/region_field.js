AUI.add(
	...
	function(A) {
		...
		var RegionField = A.Component.create(
			{
				ATTRS: {
					dataSourceOptions: {
						value: []
				...
				NAME: 'liferay-ddm-form-field-region',
				...
				prototype: {
					...
					getTemplateContext: function() {
						...
						return A.merge(
							RegionField.superclass.getTemplateContext.apply(instance, arguments),
							{
					...
					render: function() {
						...
						RegionField.superclass.render.apply(instance, arguments);
					...
					_getContextValue: function() {
						...
						var value = RegionField.superclass.getContextValue.apply(instance, arguments);
					...
					_renderErrorMessage: function() {
						...
						RegionField.superclass._renderErrorMessage.apply(instance, arguments);
		...
		Liferay.namespace('DDM.Field').Region = RegionField;
	},
	'',
	{
