 ...
 * @author Renato Rego
 */
@Component(immediate = true, property = "ddm.form.field.type.name=region")
public class RegionDDMFormFieldValueRenderer
	...
	public String render(DDMFormFieldValue ddmFormFieldValue, Locale locale) {
		...
		JSONArray optionsValuesJSONArray =
			regionDDMFormFieldValueAccessor.getValue(ddmFormFieldValue, locale);
	...
	@Reference
	protected RegionDDMFormFieldValueAccessor regionDDMFormFieldValueAccessor;
