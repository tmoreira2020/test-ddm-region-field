...
package br.com.petrobras.ddm.type.region.internal;
 ...
 */
@Component(
	immediate = true, property = "ddm.form.field.type.name=region",
	service = DDMFormFieldRenderer.class
)
public class RegionDDMFormFieldRenderer extends BaseDDMFormFieldRenderer {

	public RegionDDMFormFieldRenderer() {
	...
	protected void activate(Map<String, Object> properties) {
		_templateResource = getTemplateResource(
			"/META-INF/resources/region.soy");
		
		System.out.println(_templateResource);
	}
	...
	protected List<Object> getOptions(
		...
		RegionDDMFormFieldContextHelper regionDDMFormFieldContextHelper =
			new RegionDDMFormFieldContextHelper(
				jsonFactory, getDDMFormFieldOptions(ddmFormField),
				ddmFormFieldRenderingContext.getValue(),
				ddmFormField.getPredefinedValue(),
				ddmFormFieldRenderingContext.getLocale());

		return regionDDMFormFieldContextHelper.getOptions();
	}
